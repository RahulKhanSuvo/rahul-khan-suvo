...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen bg-[var(--background)] flex items-center justify-center p-4 selection:bg-purple-500/30">
            ...
            >
                <div className="bg-[var(--card)] border border-white/10 card-shadow p-8 rounded-2xl backdrop-blur-sm">
                    <div className="flex flex-col items-center mb-8">
                        ...
                        <h1 className="text-3xl font-bold text-[var(--foreground)] tracking-tight">Admin Portal</h1>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                        ...
                        <div className="space-y-1">
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    type="password"
                                    className="w-full bg-[var(--background)] border border-white/10 rounded-xl py-3 pl-12 pr-4 text-[var(--foreground)] focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500 transition-all placeholder:text-gray-600"
                                    placeholder="••••••••"
                                />
                            </div>
                        ...
                        <button
                            disabled={isLoading}
                            type="submit"
                            className="w-full bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-500 hover:to-blue-500 text-white font-semibold py-3 rounded-xl transition-all shadow-lg shadow-purple-500/25 flex items-center justify-center gap-2 group disabled:opacity-70 disabled:cursor-not-allowed active:scale-[0.98]"
                        >
                            {isLoading ? (
                    ...
                    <div className="mt-8 relative">
                        ...
                        <div className="relative flex justify-center text-xs uppercase">
                            <span className="bg-[var(--card)] px-4 text-gray-500">Security Verified</span>
                        </div>
                    </div>
                </div>
