      ...
      {isVisible && (
        ...
        >
          <motion.a
            ...
            whileTap={{ scale: 0.9 }}
            className="relative flex items-center justify-center w-10 h-10 md:w-12 md:h-12 bg-[#25D366] text-white rounded-full shadow-lg hover:shadow-xl transition-shadow group"
